...
<form action="../site/thanhtoan/do.php" method="post">
...
<center>
<table class="background-image" summary="Meeting Results" style="display: none;">
	<tbody>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="vpc_Amount" value="<?=$gia?>" /></td>
...
<table class="background-image" summary="Meeting Results">
	<thead>
		<tr>
			<th scope="col" colspan="4">Thông tin thanh toán</th>
		</tr>
	</thead>
	<tfoot>
		<tr>
