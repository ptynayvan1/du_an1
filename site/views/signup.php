...
<form class="col-12" method="post" action="index.php?act=signup_">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" id="exampleInputPassword2" name="sdt">
  </div>
   <div class="form-group">
    <label for="exampleInputPassword3">Địa chỉ</label>
    <input type="text" class="form-control" id="exampleInputPassword3" name="dc">
  </div>
   <div class="form-group">
    <label for="exampleInputPassword1">Thành phố</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="tp">
  </div> 

  <div class="form-group">
    <label for="exampleInputPassword1">Quốc gia</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="qg">
  </div> 
  <div class="form-group">
    <label for="exampleInputPassword1">Chứng minh nhân dân</label>
    <input type="number" class="form-control" id="exampleInputPassword1" name="cmnd">
  </div> 
  <div class="form-group">
    <label for="exampleInputPassword1">Tên đăng nhập</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="tendn">
  </div> 
  <div class="form-group">
